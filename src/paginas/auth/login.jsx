  ...
  if (response.tokenId) {
      try {
          cookie.save('token', response.tokenId);
            ...
            const user = await fetch('https://shielded-taiga-93536.herokuapp.com/usuarios/crearusuario', {
...
<main class="form-signin">
  ...
  <GoogleLogin
    clientId="646131709029-rp0ankl8f1962oopoe8dm0q7aurgeksn.apps.googleusercontent.com"
    render={renderProps => (
